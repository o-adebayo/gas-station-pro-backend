...
function ManagerAssignmentNotificationEmail({ name, link }) {
  return React.createElement(
    ...
    React.createElement(
      Preview,
      null,
      "New Store Manager Assignment Notification"
    ),
    React.createElement(
      Body,
      { style: main },
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            Text,
            { style: paragraph },
            "We are excited to inform you that you have been assigned as the manager to a store."
          ),
          React.createElement(
            Text,
            { style: paragraph },
            "Please log in to your account to view the details and start managing your assigned store."
          ),
          React.createElement(
            "div",
          ...
          React.createElement(
            Text,
            { style: footerText },
            "If you have any questions or need further assistance, please reach out to us or your administrator."
          ),
          React.createElement(
            Text,
            { style: signOff },
...
module.exports = ManagerAssignmentNotificationEmail;
