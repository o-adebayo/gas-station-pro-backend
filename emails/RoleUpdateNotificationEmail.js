...
function RoleUpdateNotificationEmail({ name, link }) {
  return React.createElement(
    ...
    React.createElement(
      Preview,
      null,
      "Your Role Has Been Updated in Gas Station Pro"
    ),
    React.createElement(
      Body,
      { style: main },
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            Text,
            { style: paragraph },
            "We are notifying you that your role within the Gas Station Pro system has been updated."
          ),
          React.createElement(
            Text,
            { style: paragraph },
            "Please log in to your account to see the changes:"
          ),
          React.createElement(
            "div",
...
module.exports = RoleUpdateNotificationEmail;
